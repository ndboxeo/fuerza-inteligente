...
const T = {
  es: {
    ...
    misAlumnos:"Mis Alumnos", hoyEntrenan:"Entrenan hoy",
    sinRutinaAsig:"Sin rutina asignada", semana:"Semana",
    nuevaRutinaRepo:"Nueva rutina en repositorio", asignar:"Asignar",
    cancelar:"Cancelar", guardarCambios:"Guardar cambios",
    misMetricas:"Mis Métricas", sinObjetivos:"Sin objetivos asignados",
    nuevoRegistro:"+ Nuevo registro", sinRegistros:"Sin registros todavía",
    evolucion:"Evolución", mejorMarca:"Mejor marca",
    proyeccion1rm:"Proyección 1RM", mejoraTotal:"Mejora total",
    sesiones:"Sesiones", promedio:"Promedio", tendencia:"Tendencia",
    creciendo:"↑ Creciendo", plan:"Plan actual", diasDescanso:"¡Día de descanso!",
    recuperate:"Aprovechá para recuperarte.", verMetricas:"Ver métricas →",
    pizarra:"Pizarra", nuevaNota:"Nueva nota...", entrenadores:"Entrenadores",
    alumnosActivos:"Alumnos activos", cuentasSuspendidas:"Cuentas suspendidas",
    vencen30:"Vencen en 30 días", vencimientos:"Vencimientos", activo:"Activo",
    ...
    guardarEnt:"Guardar entrenamiento 💾", planEjercicios:"Plan de ejercicios",
    registroEnVivo:"Registro en vivo", rpeGlobal:"RPE global del entrenamiento",
  ...
  pt: {
    ...
    recuperate:"Aproveite para se recuperar.", verMetricas:"Ver métricas →",
